...
public class EntryActivity2 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2_entry);
        overridePendingTransition(0, 0);
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }

        Log.d("ENTRY_ACTIVITAY", "onCreate: ###opened");
    ...
    static class LoadListAsyncTask extends AsyncTask<Void, Void, Pair<String, ArrayList<StickerPack>>> {
        private final WeakReference<EntryActivity2> contextWeakReference;

        LoadListAsyncTask(EntryActivity2 activity) {
        ...
        protected void onPostExecute(Pair<String, ArrayList<StickerPack>> stringListPair) {
            ...
            final EntryActivity2 entryActivity2 = contextWeakReference.get();
            if (entryActivity2 != null) {
                if (stringListPair.first != null) {
                    entryActivity2.showErrorMessage(stringListPair.first);
                } else {
                    entryActivity2.showStickerPack(stringListPair.second);
                }
            }
        }
    }
